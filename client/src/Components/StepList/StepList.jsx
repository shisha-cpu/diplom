...
const steps = [
  { icon: "fa-list", title: "Выбор навыков", descr: "Определи, какие навыки хочешь развить, и находи подходящие курсы " },
  { icon: "fa-user-plus", title: "Вход", descr: "Создай аккаунт, чтобы получить доступ к курсам и возможностям платформы." },
  { icon: "fa-book-open", title: "Изучение курсов", descr: "Проходи курсы в удобное время, изучай материалы и выполняй задания." },
  { icon: "fa-pencil-alt", title: "Создание курсов", descr: "Разрабатывай свои курсы, делись знаниями и помогай другим обучаться." },
